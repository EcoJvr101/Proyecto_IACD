...
def main():
    ...
    if 'diet_type' in df.columns and target in df.columns:
        ...
        sns.boxplot(x='diet_type', y=target, data=df, palette='Set2')
    ...
    if 'approach' in df.columns and target in df.columns:
        ...
        sns.barplot(x='approach', y=target, data=avg_approach, palette='viridis')
    ...
    if 'sex' in df.columns and target in df.columns:
        ...
        sns.boxplot(x='sex', y=target, data=df, palette='Pastel1')
